      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            One complete solution for your family's finances. Join the waitlist now — pricing locks in at launch.
          </p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-2 max-w-3xl mx-auto mb-16">
          {pricingPlans.map((plan) => (
            <Card
              key={plan.id}
              className={`relative p-8 ${plan.isPopular ? 'border-primary border-2' : ''}`}
            ...
            >
              ...
              <Button
                ...
                data-testid={`button-waitlist-${plan.id}`}
              >
                {plan.buttonText}
              </Button>
            </Card>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-sm text-muted-foreground max-w-xl mx-auto">
            Join the waitlist to reserve your spot. Pricing is indicative and subject to change at launch.
          </p>
        </div>
      </div>
      <Footer />
